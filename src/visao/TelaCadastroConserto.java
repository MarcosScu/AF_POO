...
public class TelaCadastroConserto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbCarro.setFont(new java.awt.Font("Abel", 0, 14)); 
        cbCarro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione um Carro" }));

        jLabel4.setFont(new java.awt.Font("Abel", 0, 14)); 
        jLabel4.setText("Data de entrada no conserto *");

        cbOficina.setFont(new java.awt.Font("Abel", 0, 14)); 
        ...
        try {
            ...
            jLabel5.setFont(new java.awt.Font("Abel", 0, 14)); 
            ...
            try {
                ...
                jLitensServicos.setFont(new java.awt.Font("Abel", 0, 14)); 
                ...
                jLabel3.setFont(new java.awt.Font("Abel", 0, 14)); 
                jLabel3.setText("Serviços *");

                cbServico.setFont(new java.awt.Font("Abel", 0, 14)); 
                cbServico.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione os serviços" }));

                jBadicionarServico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/ok-20x20.png"))); 
                ...
                jBdeletarServico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/deletar-20x20.png"))); 
                ...
                jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/conserto-20x20.png"))); 

                jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/plus-20-20.png"))); 

                jLabel8.setFont(new java.awt.Font("Abel", 0, 10)); 
    ...
    private void jBadicionarServicoActionPerformed(java.awt.event.ActionEvent evt) {
        item.addElement(cbServico.getSelectedItem());
        jLitensServicos.setModel(item);
    }

    private void jBdeletarServicoActionPerformed(java.awt.event.ActionEvent evt) {
    }
