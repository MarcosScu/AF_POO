...
public class TelaCadastroCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTnome.setFont(new java.awt.Font("Abel", 0, 14)); 

        jLabel8.setFont(new java.awt.Font("Abel", 0, 14)); 
        jLabel8.setText("CPF *");

        jTcpf.setFont(new java.awt.Font("Abel", 0, 14)); 

        jLabel9.setFont(new java.awt.Font("Abel", 0, 14)); 
        jLabel9.setText("Endereço *");

        jTendereco.setFont(new java.awt.Font("Abel", 0, 14)); 
        ...
        jTrg.setFont(new java.awt.Font("Abel", 0, 14)); 

        jLabel12.setFont(new java.awt.Font("Abel", 0, 14)); 
        jLabel12.setText("CNH*");

        jTcnh.setFont(new java.awt.Font("Abel", 0, 14)); 

        jLabel13.setFont(new java.awt.Font("Abel", 0, 14)); 
        jLabel13.setText("Ano do Nascimento *");

        jTnascimento.setFont(new java.awt.Font("Abel", 0, 14)); 
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/cliente-20x20.png"))); 

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/plus-20-20.png"))); 

        jLabel14.setFont(new java.awt.Font("Abel", 0, 10)); 
